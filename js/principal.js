...
let x;
  ...
  for(x=0; x<cadastroPrestador.length; x++)
  {
    ...
    areaCartao.innerHTML += `
     <article class="card">
    <div class="topo">
        <h3 class="nome-servico" id="serviceOne">${dadosCadastrais.categoriaTrabalho}</h3>
        <a href="#"> <h3 class="nome-oferecedor" id="workerNameOne">${dadosCadastrais.nomeUsuario}</h3></a>
    </div>
    <div class="descricao" id="descCardOne">
        <p>${dadosCadastrais.descTrabalho}</p>
    </div>
    <div class="botao">
